...
function obtenerProductosEnCarrito()
{
    ...
    $sentencia = $bd->prepare("SELECT productos.idProducto, productos.nombre, productos.marca, productos.precio, productos.imagen, productos.talla, productos.categoria
     FROM productos
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->query("SELECT idProducto, nombre, marca, categoria, precio, talla, imagen, description, id_proveedor FROM productos");
    return $sentencia->fetchAll();
}
